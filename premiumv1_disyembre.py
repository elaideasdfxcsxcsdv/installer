...
def check_uptime():
    ...
    if uptime >= timedelta(minutes=5):
        ...
        while time_remaining.total_seconds() > 0:
            ...
            print("---You don't need to restart PC when switching to another account.")
            print("---If you want to change settings, run the application that lets you change settings.")
            print("---For Windows 11 users, disable SVM in bios in order for premium to work.")
            print("***CHANGE LOGS (12-31-2024):")
            print("> Smoothing reduced.")
