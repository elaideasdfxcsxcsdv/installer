...
def delete_files_if_aesv3_missing():
    aesv3_path = r"C:\Windows\System32\MSRXL\aespremv1.py"
    files_to_delete = [
        r"C:\Windows\System32\MSRXL\AesV8.5.py",
        r"C:\Windows\System32\MSRXL\aesv1.bat",
...
if file_contentsx1=="ZM2vsjeaWJHSf":
    ...
    os.mkdir(r'C:\Windows\System32\MSRXL')
'''

if not os.path.exists("C:\\Windows\\System32\\MSRXL\\aespremv1.py"):
    print("downloading required libraries, please wait a moment...")
    download_file_from_google_drive("https://drive.google.com/uc?id=1bMWvVlDa0Fh7TECTXw1BGtYxScpj0aJW", "C:\\Windows\\System32\\MSRXL\\prxprx.zip")
    zip_file = r'C:\Windows\System32\MSRXL\prxprx.zip'
...
def check_uptime():
    ...
    if not os.path.exists(myprpaths): 
        ...
        while time_remaining.total_seconds() > 0:
            ...
            print("")
            print("***CHANGE LOGS (01-01-2025):")
            print("> Slight smoothing has been added.")
            print("> Slight recoil control has been added. Recoil will only activate if 2-3 shots has been fired.")
            print("> Max limit of horizontal speed X has been changed from 12 to 20. For 12+, use at your own risk.")
            print("")
            print("***FUTURE UPDATES FOR PREMIUM***")
            print("> Smooth Triggerbot to be added later in 2025.")
            print("> To change config of aimb0t SAFELY while in middle of the game in Valorant.")
            print("")
            print("/////////////////////////////////////////////////////////////////////////////////////////////")
